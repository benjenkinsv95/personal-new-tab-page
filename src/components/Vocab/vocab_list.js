const vocab = [
  {
    'hide': false,
    'latin': '-ne (attached to the end of the first word in the sentence, usually the most important word in the question)',
  ...
  },
  {
    ...
    'english': 'to believe, trust (+ dat. of person believed; + acc. of thing believed)'
  },
  {
    'hide': false,
  ...
  },
  {
    ...
    'english': 'to teach (often with 2 accusatives: one of the person, the other of the thing taught)'
  },
  {
    'hide': false,
  ...
  },
  {
    ...
    'english': 'enemy (of the state, usually used in the plural; contrast inimīcus = a personal enemy)'
  },
  {
    'hide': false,
    'latin': 'humus, humī, f.',
  ...
  },
  {
    ...
    'english': 'to pray, beg (for) (often with two accusatives: one of the person, the other of the thing)'
  },
  {
    'hide': false,
...
class VocabList {
  ...
  nextVocab () {
    ...
    while (
      !this._vocab || this._vocab.hide ||
      (currentDate - new Date(this._vocab.updatedAt)) < TEN_MINUTES
    ) {
